...
const courseInfo = { name: 'Code 301', duration: { dayTrack: '4 weeks', eveningTrack: '8 weeks' }, topics: ['SMACSS', 'APIs', 'NodeJS', 'SQL', 'jQuery', 'functional programming'], finalExam: true };
...
const totalCharacters = arr => {
  ...
  for (let i = 0; i < arr.length; i++) {
    ...
    names.push(arr[i].spouse);
    names.push(...arr[i].children);
  }
  names.splice(names.indexOf(null), 1);
  return names.length;
};
